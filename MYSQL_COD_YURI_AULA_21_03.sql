...
/*	OUTRA FORMA DE CRIAR O RELACIONAMENTO DIRETAMENTE NA CRIAÇÃO DA TABELA DEPENDENTE/SECUNDÁRIA
	OBS.: A TABELA INDEPENDENTE/PRIMÁRIA(tb_categorias) PRECISA TER SIDO CRIADA ANTES
